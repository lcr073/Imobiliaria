...
<table width=666 cellspacing=0 cellpadding=0 border=0><tr><td valign=top class=cp><DIV ALIGN="CENTER"><?php echo utf8_encode("Instruções
de Impressão") ?></DIV></TD></TR><TR><TD valign=top class=cp><DIV ALIGN="left">
<p>
<li><?php echo utf8_encode("Imprima em impressora jato de tinta (ink jet) ou laser em qualidade normal ou alta (Não use modo econômico.) ")?><br>
<li><?php echo utf8_encode("Utilize folha A4 (210 x 297 mm) ou Carta (216 x 279 mm) e margens mínimas à esquerda e à direita do formulário.")?><br>
<li><?php echo utf8_encode("Corte na linha indicada. Não rasure, risque, fure ou dobre a região onde se encontra o código de barras.")?><br>
<li><?php echo utf8_encode("Caso não apareça o código de barras no final, clique em F5 para atualizar esta tela.")?>
<li><?php echo utf8_encode("Caso tenha problemas ao imprimir, copie a seqüencia numérica abaixo e pague no caixa eletrônico ou no internet banking:")?><br><br>
<span class="ld2">
...
<?php echo utf8_encode("Outras deduções") ?></td><td class=ct valign=top width=7 height=13><img height=13 src=../imagens/1.png width=1 border=0></td><td class=ct valign=top width=113 height=13>(+)
...
<?php echo utf8_encode("Outros acréscimos") ?></td><td class=ct valign=top width=7 height=13><img height=13 src=../imagens/1.png width=1 border=0></td><td class=ct valign=top width=180 height=13>(=)
...
</tr><tr><td valign=top width=7 height=1><img height=1 src=../imagens/2.png width=7 border=0></td><td valign=top width=659 height=1><img height=1 src=../imagens/2.png width=659 border=0></td></tr></tbody></table><table cellspacing=0 cellpadding=0 border=0><tbody><tr><td class=ct  width=7 height=12></td><td class=ct  width=564 >Demonstrativo</td><td class=ct  width=7 height=12></td><td class=ct  width=88 ><?php echo utf8_encode("Autenticação
...
documento</td><td class=ct valign=top width=7 height=13> <img height=13 src=../imagens/1.png width=1 border=0></td><td class=ct valign=top width=62 height=13><?php echo utf8_encode("Espécie
...
processamento</td><td class=ct valign=top width=7 height=13> <img height=13 src=../imagens/1.png width=1 border=0></td><td class=ct valign=top width=180 height=13><?php echo utf8_encode("Nosso
...
<img height=13 src=../imagens/1.png width=1 border=0></td><td class=ct valign=top width=53 height=13><?php echo utf8_encode("Espécie") ?></td><td class=ct valign=top height=13 width=7>
...
<td valign=top width=7 height=1><img height=1 src=../imagens/2.png width=1 border=0></td></tr></tbody></table></td><td valign=top width=468 rowspan=5><font class=ct><?php echo utf8_encode("Instruções
...
<?php echo utf8_encode("Outras deduções") ?></td></tr><tr><td class=cp valign=top width=7 height=12> <img height=12 src=../imagens/1.png width=1 border=0></td><td class=cp valign=top align=right width=180 height=12></td></tr><tr><td valign=top width=7 height=1><img height=1 src=../imagens/2.png width=7 border=0></td><td valign=top width=180 height=1><img height=1 src=../imagens/2.png width=180 border=0></td></tr></tbody></table></td></tr><tr><td align=right width=10>
...
<td class=ct valign=top width=7 height=13><img height=13 src=../imagens/1.png width=1 border=0></td><td class=ct valign=top width=180 height=13><?php echo utf8_encode("Cód.
baixa") ?></td></tr><tr><td valign=top width=7 height=1><img height=1 src=../imagens/2.png width=7 border=0></td><td valign=top width=472 height=1><img height=1 src=../imagens/2.png width=472 border=0></td><td valign=top width=7 height=1><img height=1 src=../imagens/2.png width=7 border=0></td><td valign=top width=180 height=1><img height=1 src=../imagens/2.png width=180 border=0></td></tr></tbody></table><TABLE cellSpacing=0 cellPadding=0 border=0 width=666><TBODY><TR><TD class=ct  width=7 height=12></TD><TD class=ct  width=409 >Sacador/Avalista</TD><TD class=ct  width=250 ><div align=right><?php echo utf8_encode("Autenticação
